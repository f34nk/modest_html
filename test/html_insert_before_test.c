...
int insert_multiple_nodes_before_single_node_test(html_workspace_t* w)
{
  MODEST_HTML_LOG
...
int insert_single_node_before_multiple_nodes_test(html_workspace_t* w)
{
  MODEST_HTML_LOG
  ...
  const char* new_html = "<span>Insert</span>";
  int new_tree_index = html_parse_tree(w, new_html, strlen(new_html));
  const char* new_scope_name = "body_children";
  int new_collection_index  = html_select_scope(w, new_tree_index, new_scope_name);
...
int insert_multiple_nodes_before_multiple_nodes_test(html_workspace_t* w)
{
  MODEST_HTML_LOG
...
#define max_tests 5
int (*test[max_tests])() = {insert_single_node_before_single_node_test, insert_multiple_nodes_before_single_node_test, insert_single_node_before_multiple_nodes_test, insert_multiple_nodes_before_multiple_nodes_test, insert_text_before_single_node_test};
