...
int main(int argc, char const *argv[])
{
  ...
  html_insert_after(w, s1.collection_index, new_s1.collection_index);
  ...
  printf("%d: %s\n", ++i, result);
  if(result != NULL && strcmp(result, "<body><div><p class=\"hello\">Hello</p><span>Hello</span>World</div></body>") != 0){
  ...
  // html_insert_after(w, s2.collection_index, new_s2.collection_index);
  // scope_name = "body";
